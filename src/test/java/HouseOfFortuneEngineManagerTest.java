...
public class HouseOfFortuneEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(HouseOfFortuneEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HouseOfFortune/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HouseOfFortune/InitOutcome.xml").getDocumentElement();
